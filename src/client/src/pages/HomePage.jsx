      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-gray-300">Определите условия, ставки и пригласите друзей в качестве участников или арбитров</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300">Загружайте доказательства, следите за историей и повышайте свой рейтинг побед</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300">Устанавливайте таймеры для споров с ограничением по времени и получайте уведомления</p>
          </motion.div>
        </div>
